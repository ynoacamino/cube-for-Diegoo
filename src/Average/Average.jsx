  ...
  return (
    <div className="Average">
      <div className="boxAverage">
        ...
        <span className="spanNumAverage">{statistics.media || '- -'}</span>
      </div>
      <div className="boxAverage">
        <span className="spanNameAverage">Mejor:</span>
        <span className="spanNumAverage">{statistics.best === 999999 ? '- -' : statistics.best}</span>
      </div>
      <div className="boxAverage">
        <span className="spanNameAverage">Ao5:</span>
        <span className="spanNumAverage">{statistics.ao5 || '- -'}</span>
      </div>
      <div className="boxAverage">
        <span className="spanNameAverage">Ao12:</span>
        <span className="spanNumAverage">{statistics.ao12 || '- -'}</span>
      </div>
      <div className="boxAverage">
